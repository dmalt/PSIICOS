function [NormAre, NormArep, NormAim, NormAimp,NormVC1, NormVC1p,NormVC2, NormVC2p,RFirstSecond, CFirstSecond] = MeasureAttenuationVsDistAndCorrCoef(Upwr,G,R,N,Nmc)
...
for mc = 1:Nmc
    ...
    Avc1p  = Avc1-Upwr*(Upwr'*Avc1);
    Avc2p  = Avc2-Upwr*(Upwr'*Avc2);
